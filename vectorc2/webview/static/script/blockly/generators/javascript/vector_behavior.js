...
Blockly.JavaScript['vector_behavior_turn_in_place'] = function(block) {
  ...
  var value_speed = Blockly.JavaScript.valueToCode(block, 'speed', Blockly.JavaScript.ORDER_ATOMIC);
  var value_accel = Blockly.JavaScript.valueToCode(block, 'accel', Blockly.JavaScript.ORDER_ATOMIC);
  var value_angle_tolerance = Blockly.JavaScript.valueToCode(block, 'angle_tolerance', Blockly.JavaScript.ORDER_ATOMIC);
